...
def load_config():
    ...
    return acceptable_difference, input_file, output_file, editable_output
...
def analyze_file(file_path: str, acceptable_difference: float) -> Optional[Dict[str, Any]]:
...
def main():
    ...
    # Get configuration
    acceptable_difference, input_file, output_file, editable_output = load_config()
    ...
    for video_file in video_files:
        analysis = analyze_file(video_file, acceptable_difference)
        if analysis:
